...
TARGET_FILE = './testdir/did_innerpuz.clvk.hex'
...
def test_compile_clvk(source, output, paths, want_sha256):
    compile_clvk(source, output, paths)
...
test_compile_clvk(SOURCE_FILE, TARGET_FILE, SEARCH_PATHS, COMPILED_HASH)
...
try:
    test_compile_clvk(SOURCE_FILE, TARGET_FILE, SEARCH_PATHS, None)
