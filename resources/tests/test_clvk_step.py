...
import json
from chiklisp import start_clvk_program, compose_run_function
...
def simple_test():
    p = start_clvk_program('ff02ffff01ff02ff02ffff04ff02ffff04ff05ff80808080ffff04ffff01ff02ffff03ffff09ff05ffff010180ffff01ff0101ffff01ff12ff05ffff02ff02ffff04ff02ffff04ffff11ff05ffff010180ff808080808080ff0180ff018080', 'ff0580', {"de3687023fa0a095d65396f59415a859dd46fc84ed00504bf4c9724fca08c9de":"factorial"})
...
def complex_test():
    ...
    p = start_clvk_program(open(str(testpath.joinpath('fact.clvk.hex'))).read(), 'ff0580', symbols, {
...
def test_with_printing():
    ...
    p = start_clvk_program(open(str(testpath.joinpath('mandelbrot.clvk.hex'))).read(), 'ff82ff40ff8180ff82ff70ff81a0ff0880', symbols, {})
...
def single_function_test():
    ...
    start_program = open(str(testpath.joinpath('twofun.clvk.hex'))).read();
    torun = compose_run_function(start_program, symbols, "second-fun");
    p = start_clvk_program(torun, 'ff0780', symbols)
