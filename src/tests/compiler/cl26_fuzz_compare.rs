...
fn compile_chiklisp_043_to_hex(program: &str) -> String {
...
#[test]
fn random_cl26_programs_match_chiklisp_043_hex() {
    for seed in 0..GENERATED_PROGRAMS_TO_COMPARE {
        ...
        let chiklisp_043_hex = compile_chiklisp_043_to_hex(&program);
        assert_eq!(
            current_hex.trim(),
            chiklisp_043_hex.trim(),
