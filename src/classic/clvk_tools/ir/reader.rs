...
use crate::classic::clvk::casts::bigint_to_bytes_clvk;
use crate::classic::clvk::syntax_error::SyntaxErr;
use crate::classic::clvk_tools::ir::r#type::{IRRepr, NEW_BIT_CONSTANTS};
...
pub fn interpret_atom_value(chars: &[u8], language_flags: u32) -> Result<IRRepr, SyntaxErr> {
    ...
    if chars.is_empty() {
        ...
        if chars.len() == 1 {
            ...
            return Ok(IRRepr::Int(bigint_to_bytes_clvk(&Number::default()), true));
        }
