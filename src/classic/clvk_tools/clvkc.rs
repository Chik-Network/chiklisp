...
use crate::classic::clvk_tools::stages::run;
...
pub fn compile_clvk_text_maybe_opt(
    ...
    if let Some(stepping) = dialect.stepping {
        ...
        Ok(convert_to_clvk_rs(allocator, res)?)
    } else {
