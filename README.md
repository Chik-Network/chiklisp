...
[![Coverage Status](https://coveralls.io/repos/github/Chik-Network/chiklisp/badge.svg?branch=base)](https://coveralls.io/github/Chik-Network/clvk_tools_rs?branch=base)
...
[![Crates.io](https://img.shields.io/crates/v/chiklisp.svg)](https://crates.io/crates/clvk_tools_rs)
...
or via pip
    ...
    pip install chiklisp@git+https://github.com/Chik-Network/clvk_tools_rs.git@e17412032aa7d3b8b1d1f931893fb5802eee626a
...
in that way is like this:
    ...
    import json
    from chiklisp import compile_clvk
...
This is a second-hand port of chik's [clvk tools](https://github.com/Chik-Network/clvk_tools/) to rust via the work of
...
Some reasons for doing this are:
 ...
 - Chik switched the clvk implementation to rust: [clvk_rs](https://github.com/Chik-Network/clvk_rs), and this code may both pick up speed and track clvk better being in the same language.
...
these command line tools from clvk_tools in their equivalents in this repository
